...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { address: @prospect.address, company: @prospect.company, email: @prospect.email, first_name: @prospect.first_name, last_name: @prospect.last_name, phone: @prospect.phone, position: @prospect.position } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { address: @prospect.address, company: @prospect.company, email: @prospect.email, first_name: @prospect.first_name, last_name: @prospect.last_name, phone: @prospect.phone, position: @prospect.position } }
